        ...
        >
          ...
          >
            <div style={{ marginLeft: "15px" }}>
              ...
              <u>
                <p style={cat=="Easter"?{color:"blue"}:null} onClick={()=>setCat("Easter")}>Easter Color Rose</p>
              </u>
              
              <u>
                <p style={cat=="Red Rose"?{color:"red"}:null }onClick={()=>setCat("Red Rose")}>Red Color Rose</p>
              </u>
              <u>
                <p style={cat=="pink Rose"?{color:"green"}:null }onClick={()=>setCat("Pink Rose")}>Pink Color Rose</p>
              </u>
              <u>
                <p style={cat=="Orange Rose"?{color:"orange"}:null }onClick={()=>setCat("Orange Rose")} >Orange Color Rose</p>
              </u>
              <u>
                <p style={cat=="White Rose"?{color:"white"}:null }onClick={()=>setCat("White Rose")}>White Color Rose</p>
              </u>
              <u>
                <p style={cat=="Purple Rose"?{color:"purple"}:null }onClick={()=>setCat("Purple Rose")}>Purple Color Rose</p>
              </u>
             
              <u>
                <p style={cat=="Yellow Rose"?{color:"yellow"}:null }onClick={()=>setCat("Yellow Rose")}>Yellow Color Rose</p>
              </u>
