    ...
    <div style={{ marginBottom: "15px" }}>
      ...
      <div className={style.zoomImages}>
        ...
        <div className={style.zoomwrapper}>
          <div  className={style.zoomProduct}>
      ...
      <div>
            <div className={style.insta}>
              <div>
                <img src = "https://images.contentstack.io/v3/assets/bltdd99f24e8a94d536/blt4661dd99d6401481/60184a440f1c0c1aa6f87986/instagram-icon.svg?quality=85&auto=webp&optimize={medium}" alt="instagram"></img>
              </div>
              <p>Share Your <span className={style.span}>#MadeMeSmile</span> Flowers Moment</p>
            </div>
        <div className={style.instaImages}>
            <div className={style.zoomInsta}>
