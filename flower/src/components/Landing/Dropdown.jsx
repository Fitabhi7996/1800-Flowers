      ...
      <Flex
        ...
        <Flex
          ...
          <Flex direction="column" >
            ...
            />
            <p style={{ padding: "0", margin: "0" }}>Menu</p>
          </Flex>

          {/* logo */}
          <Box w="40%" onClick={()=>nav("/")}>
            <Img src={logo} alt="logo" w="100%" h="60px"></Img>
          </Box>

          {/* cart */}

          <Flex direction="column"  onClick={()=>nav("/cart")}>
            <Img src="https://images.contentstack.io/v3/assets/bltdd99f24e8a94d536/blt52e2dc247725d3eb/641dcc8b2fa7357de06f2451/cartEmpty.svg" alt="cart" pt="12px" height="32px"></Img>
              <p style={{ padding: "0", margin: "0" ,paddingTop:"3px"}}>Cart</p>
          </Flex>
          ...
          <Popover trigger={'hover'} placement={'bottom-start'} >
            <PopoverTrigger W="100%" >
              <Link
                ...
                fontSize={{base:"12px",md:"7px",lg:"min(1.2vw, 0.95rem)"}}
                fontWeight={600}
                color={"rgb(47, 47, 47)"}
                _hover={{
                  // textDecoration: 'none',
            ...
            {navItem.children && (
              ...
              >
                <Flex gap="15px" w="80%" justify={"space-between"} m="auto">
